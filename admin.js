(() => {
  ...
  const injectStyles = () => {
    ...
    style.textContent = `
      ...
      .admin-panel__input{flex:1 1 140px;padding:10px 12px;border-radius:10px;border:1px solid rgba(74,222,128,0.5);background:rgba(12,20,20,0.85);color:#e8fff0;font-size:14px;}
      .admin-panel__btn{padding:10px 14px;border-radius:10px;border:none;background:linear-gradient(135deg,#4ade80,#16a34a);color:#f0fdf4;font-weight:600;cursor:pointer;transition:transform .15s ease, box-shadow .15s ease;}
      .admin-panel__btn:hover{transform:translateY(-1px);box-shadow:0 12px 20px rgba(74,222,128,0.35);}
      .admin-panel__btn--ghost{background:rgba(74,222,128,0.16);color:#e8fff0;}
      .admin-panel__btn--ghost:hover{box-shadow:0 12px 20px rgba(74,222,128,0.25);}
      .admin-panel__hint{font-size:13px;color:#99d6a8;margin:0;}
      .admin-panel__status{font-size:13px;color:#66d991;margin:0;}
      .admin-panel__section--meta{font-size:13px;color:#99d6a8;}
      .admin-panel__section--meta button{width:100%;}
      .admin-wa-target{outline:1px dashed rgba(74,222,128,0.6);outline-offset:4px;position:relative;}
      .admin-wa-target::after{content:'WA';position:absolute;top:-10px;right:-10px;font-size:11px;background:rgba(74,222,128,0.85);color:#f0fdf4;padding:2px 6px;border-radius:999px;}
